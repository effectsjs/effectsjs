...
export default function ForkMe () {
  return (
    <React.Fragment>
      <a href="https://github.com/effectsjs/effectsjs" className="github-corner" aria-label="View source on GitHub">
        <svg width="80" height="80" viewBox="0 0 250 250" id='fork_me' aria-hidden="true"
