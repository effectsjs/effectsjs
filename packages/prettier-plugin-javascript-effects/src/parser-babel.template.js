/**
 * @description
 * direct copy of node_modules/prettier/src/language-js/parser-babel.js,
 * with small adjustments for effects.
 * all effects modifications shall be annotated with the keyword effectsjs in
 * adjacent comments.
 *
 * @warn
 * anything that can be editted in `plugin.ts` shall do so. we want to
 * minimally hack around this source code. prettier source _does not_ let
 * us configure much of the JS language or compiler config, hence, we must
 * copy, edit, and re-bundle their logic on our own. :/
 */
"use strict";
